/**** XeonPhi NativeMode + Pthread by fujish ****/
/************************************************/
/**** N-queens since 2004-09   by Kenji KISE ****/
/**** N-queens Pthread Version in C          ****/
/************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <sys/time.h>
...
#define THREAD_NUM	244
#define SPLIT		10

/************************************************/
#define NAME "qn24b XeonPhiPthread"
...
void thread_func(void *arg)
{
    ...
    while (1)
	{
		start_j = get_next_job();
		end_j = start_j + SPLIT;
		
		for(j=start_j; j<end_j; j++)
		{
			if(j <= jobs)
				rets[j] = solver(n, j, jobs, prob);
			else
				return;
		}
	}
